    ...
    return (
        <div className={classes.Section} >
            ...
            <div className={classes.About}>
                ...
                <p>We offer a comprehensive range of repair and modification services classic gaming consoles and games, and we will work with you to get your favorite consoles and games working like new or better! </p>
